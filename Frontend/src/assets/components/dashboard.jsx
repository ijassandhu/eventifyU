...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      <div className='bg-[#222] flex flex-col md:hidden pb-16 pt-16'>
        ...
        <div className='flex-1 px-4'>
          <div className='bg-[#2b2b2b] rounded-2xl flex flex-col mt-3 pb-4 shadow-lg'>
            <h1 className='text-lg text-gray-400 p-4'>{(new Date()).toLocaleDateString('en-US', DATE_OPTIONS)}</h1>
            <h2 className='text-xl text-white pl-4 mb-4'>Student Complete Detail</h2>
            <hr className='border-gray-600' />
            <div className='flex flex-col p-3 gap-4'>
              {[
                ...
                <div key={index} className='inputParent wrap-input-2 p-2 flex flex-col'>
                  <label htmlFor={input.label} className="text-white self-start text-sm"><span className='text-red-400'>*</span>{input.label}</label>
                  <input
